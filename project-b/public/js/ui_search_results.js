...
/***/ "./resources/assets/js/ui_search_results.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/ui_search_results.js ***!
  \**************************************************/
/*! no exports provided */
...
var app = new Vue({
  ...
  methods: {
    ...
    applyResultMarkers: function applyResultMarkers() {
      var cs = [];

      var _iterator = _createForOfIteratorHelper(this.resultData),
          _step;
      ...
      var _iterator2 = _createForOfIteratorHelper(this.countries),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _r = _step2.value;
          _r.marker = this.addMarker(_r.name, _r);
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
    ...
    updateMarker: function updateMarker(index) {
    ...
    changeMarkerRed: function changeMarkerRed(index) {
      this.changeMarkerIcon(index, "https://maps.google.com/mapfiles/ms/icons/red-dot.png");
    },
    changeMarkerBlue: function changeMarkerBlue(index) {
      this.changeMarkerIcon(index, "https://maps.google.com/mapfiles/ms/icons/blue-dot.png");
    },
    changeMarkerIcon: function changeMarkerIcon(index, iconUrl) {
      this.countries[index].marker.setMap(null); //console.log(this.countries[index].marker.getIcon());
    ...
    addMarker: function addMarker(title, location, callback) {
...
/***/ 3:
/*!********************************************************!*\
  !*** multi ./resources/assets/js/ui_search_results.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\bi18027\Documents\授業\3年前期\ネットワークプログラミング\_laravel\netpro\resources\assets\js\ui_search_results.js */"./resources/assets/js/ui_search_results.js");
